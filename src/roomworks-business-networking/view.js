...
document.addEventListener( 'DOMContentLoaded', function () {
	...
	roots.forEach( function ( root ) {
		...
		function renderPagination( data ) {
			...
			paginationRange( data.page, data.total_pages ).forEach( function ( page ) {
				if ( '...' === page ) {
		...
		if ( filterActions ) {
			filterActions.addEventListener( 'click', function ( event ) {
				...
				[ 'rbn_search', 'rbn_category', 'rbn_service', 'rbn_location' ].forEach( function ( name ) {
