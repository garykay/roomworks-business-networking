...
return array(
	'roomworks-advertising-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'roomworks-business-networking/roomworks-advertising-block',
		'version' => '1.0.0',
		'title' => 'Advertising',
		'category' => 'widgets',
		'icon' => 'megaphone',
		'description' => 'Shows the advert assigned to the current page/post (see the Advert field in the editor sidebar). Place inside a Site Editor template.',
		'example' => array(
	...
	'roomworks-community-notice-board' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		'name' => 'roomworks-business-networking/roomworks-community-notice-board',
		'version' => '1.0.0',
		'title' => 'Community Notice Board',
		'category' => 'widgets',
		'icon' => 'buddicons-community',
		'description' => 'Searchable, filterable board of members\' requests for work to be done.',
		'example' => array(
