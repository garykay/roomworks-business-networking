...
// rbn_confirm_deletion/rbn_edit_business/rbn_edit_job/
// rbn_confirm_delete_business only toggle which copy/button or which
// business/job the account-deletion/business/requests sections show on
// THIS load; stripped here so none of them gets carried into the hidden
// redirect field of every other form on the page.
$current_url = remove_query_arg( array( 'rbn_confirm_deletion', 'rbn_edit_business', 'rbn_edit_job', 'rbn_confirm_delete_business' ), $current_url );
